...
SITES = [
    ...
    ("Tower of London", "Tower of London", "landmark", "\U0001F3F0", 51.508217, -0.0761879,
        ...
        ("Tower Bridge", "Tower Bridge", "landmark", "\U0001F309", 51.5055039, -0.0754056,
         "Walk across for free — exhibition inside if you want. Morning light is best for photos.", True, ""),
        ("Sky Garden", "Sky Garden", "landmark", "\U0001F33F", 51.5113434, -0.0835715,
         "Free public garden at the top of 20 Fenchurch St (the Walkie Talkie) — book a free entry slot online. 10-min walk from Tower Bridge.", True, ""),
        ...
        ("Paddington Station", "Paddington Station", "landmark", "\U0001F682", 51.5157202, -0.1760321,
         "Quick stop — Paddington Bear statue + shop on Platform 1. 15-min walk from Daunt Books, or one Bakerloo stop from Marylebone.", True, ""),
